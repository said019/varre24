...
En Pilates Room celebramos contigo este nuevo año de vida. Que esté lleno de movimiento, fuerza y momentos de calma.
...
Disfruta tu día, te esperamos en el estudio.`,
  },
  {
    id: "short",
    label: "Cortito",
    text: `¡Feliz cumple, {name}! 🎂 Te deseamos un día hermoso lleno de movimiento y buenas vibras. — Pilates Room`,
  },
  {
    id: "blank",
    label: "En blanco",
...
export function BirthdaysWidget() {
  ...
  return (
    <div className="rounded-[1.35rem] border border-[#836A5D]/15 bg-white/65 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.7),0_18px_50px_-38px_rgba(84,67,49,0.5)] backdrop-blur">
      <div className="mb-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-[#bea98f]/30 to-[#836A5D]/15 text-[#836A5D]">
            <Cake size={16} />
          </span>
          <div>
            <p className="text-sm font-bold text-[#2f2823] leading-tight">Cumpleaños</p>
            <p className="text-[11px] text-[#836A5D]/65 leading-tight">{list.length} próxim{list.length === 1 ? "o" : "os"} en 45 días</p>
          </div>
        </div>
        {today.length > 0 && (
          <span className="inline-flex items-center gap-1 rounded-full bg-[#bea98f]/25 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wider text-[#544331]">
            <Sparkles size={10} />
            {today.length} hoy
          </span>
        )}
      ...
      {isLoading ? (
        ...
        <div className="rounded-xl border border-dashed border-[#836A5D]/25 px-4 py-8 text-center">
          <p className="text-sm text-[#5F4B3D]/55">Sin cumpleaños próximos</p>
          <p className="text-[11px] text-[#5F4B3D]/40 mt-1">Las clientas que registren su fecha de nacimiento aparecerán aquí.</p>
        </div>
      ) : (
        <div className="divide-y divide-[#836A5D]/10">
              ...
              <div key={b.id} className="flex items-center gap-3 py-3 first:pt-0 last:pb-0">
                <div className="relative shrink-0">
                  {b.photoUrl ? (
                    ...
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#725D51] to-[#bea98f] text-[#F5ECDB] text-xs font-semibold flex items-center justify-center">
                      {initials}
                    </div>
                  )}
                  {isToday && (
                ...
                <div className="min-w-0 flex-1">
                  <p className="font-medium text-sm text-[#2f2823] truncate leading-tight">{b.displayName}</p>
                  <p className="text-[11px] text-[#836A5D]/70 leading-tight mt-0.5">
                ...
                <Button
                  ...
                  className={isToday
                    ? "bg-[#bea98f] hover:bg-[#aa9376] text-[#2f2823] font-semibold text-xs h-8"
                    : "text-[#725D51] hover:text-[#544331] hover:bg-[#bea98f]/15 text-xs h-8"
                  }
          ...
          {list.length > 6 && (
            <p className="pt-3 text-center text-[11px] text-[#836A5D]/55">+{list.length - 6} más</p>
          )}
        </div>
      )}
        ...
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              <Cake size={16} className="text-[#bea98f]" />
            ...
            <DialogDescription>
              ...
              <span className="block text-[11px] mt-1 text-[#836A5D]/60">Usa <code className="text-[#725D51]">{"{name}"}</code> para personalizar.</span>
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="rounded-xl border border-[#836A5D]/15 divide-y divide-[#836A5D]/10">
                <div className="flex items-center justify-between gap-3 px-3 py-2.5">
                  <div className="flex items-center gap-2">
                    <Mail size={14} className="text-[#725D51]" />
                    <div>
                      <p className="text-sm font-medium text-[#2f2823]">Email</p>
                ...
                <div className="flex items-center justify-between gap-3 px-3 py-2.5">
                  <div className="flex items-center gap-2">
                    <MessageSquare size={14} className="text-[#725D51]" />
                    <div>
                      <p className="text-sm font-medium text-[#2f2823]">WhatsApp</p>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              className="bg-[#bea98f] hover:bg-[#aa9376] text-[#2f2823] font-semibold"
            >
