  ...
  return (
    <button
      ...
      className={cn(
        ...
        count > 0
          ? "border-[#3B0E1A]/30 bg-[#3B0E1A]/8 text-[#3B0E1A] hover:bg-[#3B0E1A]/14"
          : "border-[#3B0E1A]/12 bg-white/45 text-[#3B0E1A]/55 hover:bg-white/70",
      )}
    >
      ...
      {count > 0 && (
        <span
          aria-hidden="true"
          className="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 rounded-full bg-[#b3261e] text-white text-[10px] font-bold leading-none tabular-nums inline-flex items-center justify-center shadow-sm ring-2 ring-[#FCF8F7]"
        >
          {count > 99 ? "99+" : count}
        </span>
      )}
