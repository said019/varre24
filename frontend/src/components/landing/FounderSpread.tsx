...
export function FounderSpread() {
  ...
  return (
    <section ref={ref} className="grid items-center gap-0 bg-[#F3EFE9] md:grid-cols-2">
      ...
      <Reveal className="px-6 py-16 sm:px-10 lg:px-16">
        <p className="font-alilato text-xs uppercase tracking-[0.24em] text-[#3B0E1A]">{FOUNDER.role}</p>
        <h2 className="font-bebas mt-2 text-[clamp(2.4rem,5vw,4.5rem)] leading-none tracking-tight text-[#1A060B]">
          {FOUNDER.name}
        </h2>
        <p className="font-editorial mt-6 text-2xl italic text-[#260910]">“{FOUNDER.quote}”</p>
        <div className="font-alilato mt-6 space-y-4 text-[#1A060B]/80">
