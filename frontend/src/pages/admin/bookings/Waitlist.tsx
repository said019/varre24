            ...
            <div className="space-y-5">
              ...
              {rosterLoading ? (
                ...
                <div className="rounded-2xl border border-[#836A5D]/15 bg-[#836A5D]/[0.04] p-5">
                  <div className="flex items-start justify-between">
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        <span className="w-2.5 h-2.5 rounded-full shrink-0" style={{ backgroundColor: classInfo.color || "#836A5D" }} />
                  ...
                  <div className="mt-3">
                    <Badge variant="outline" className="text-[#C8B79E] border-[#C8B79E]/30 bg-[#C8B79E]/5">
                ...
                {rosterLoading
                  ...
                  : roster.length === 0
                    ...
                    : roster.map((entry, idx) => (
                      <div
                        key={entry.bookingId}
                        className="flex items-center gap-4 p-4 rounded-xl border border-[#C8B79E]/15 bg-[#C8B79E]/5 transition-all"
                      >
                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#C8B79E]/20 to-[#836A5D]/10 border border-[#C8B79E]/20 flex items-center justify-center text-sm font-bold text-[#C8B79E]">
                          #{idx + 1}
                        </div>
                        ...
                        <span className="text-[11px] font-semibold px-2.5 py-1 rounded-full border text-[#C8B79E] border-[#C8B79E]/30 bg-[#C8B79E]/5 shrink-0">
                          Posición {idx + 1}
                        </span>
                      </div>
                    ))
                          ...
                          {dayClasses.map((cls: any) => {
                            ...
                            return (
                              <button
                                ...
                                className="w-full flex items-center gap-4 p-4 rounded-xl border border-[#836A5D]/15 bg-[#836A5D]/[0.04] hover:border-[#C8B79E]/30 hover:bg-[#C8B79E]/5 transition-all group text-left"
                              >
                                <span
                                  className="w-2.5 h-2.5 rounded-full shrink-0"
                                  style={{ backgroundColor: cls.class_type_color ?? cls.color ?? "#C8B79E" }}
                                />
                                <div className="flex-1 min-w-0">
                                ...
                                <ChevronRight size={14} className="text-[#2d2d2d]/20 group-hover:text-[#C8B79E]/60 transition-colors" />
                              </button>
                            );
                          })}
                        </div>
