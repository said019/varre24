            ...
            {isLoading
              ...
              : memberships.map((m) => {
                const catColors: Record<string, string> = {
                  pilates: "bg-[#C8B79E]/15 text-[#C8B79E] border-[#C8B79E]/30",
                  bienestar: "bg-[#836A5D]/15 text-[#836A5D] border-[#836A5D]/30",
                  all: "bg-[#F5ECDB]/15 text-[#F5ECDB] border-[#F5ECDB]/30",
                };
                  ...
                  <TableRow key={m.id}>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        {cat && cat !== "all" && (
                          <span className={`text-[10px] font-semibold px-1.5 py-0.5 rounded-full border capitalize ${catColors[cat] ?? "text-[#2d2d2d]/40 border-[#836A5D]/15"}`}>
                            {cat}
                          </span>
                        )}
                      </div>
          ...
          <DialogContent className="max-w-md">
            ...
            <form onSubmit={form.handleSubmit((d) => createMutation.mutate(d))} className="space-y-4">
              ...
              {(() => {
                ...
                return (
                  <div className="space-y-1 rounded-lg border border-[#C8B79E]/15 bg-[#C8B79E]/[0.03] p-3">
                ...
                return (
                  <div className="rounded-xl border border-[#836A5D]/20 bg-[#f4f5ef]/60 p-3 space-y-1">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      {discountTotal ? (
                        <div className="flex items-center gap-2">
                          <span className="text-xs text-[#836A5D] line-through">${total.toLocaleString("es-MX")}</span>
