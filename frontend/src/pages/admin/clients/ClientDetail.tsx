            ...
            <TabsContent value="creditos" className="mt-4">
              ...
              {(() => {
                ...
                return guestEvents > 0 ? (
                  <p className="text-xs mb-3 inline-flex items-center gap-1.5 rounded-full bg-[#F0E6D6] text-[#6b5444] px-3 py-1">
        ...
        <Dialog open={!!resetResult} onOpenChange={(o) => { if (!o) setResetResult(null); }}>
          <DialogContent className="max-w-sm">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between gap-2 rounded-lg border border-border bg-[#f4f5ef]/60 px-3 py-2.5">
                <code className="text-lg font-bold tracking-wide text-[#2d2d2d]">{resetResult?.tempPassword}</code>
                <Button
