            ...
            <TabsContent value="creditos" className="mt-4">
              ...
              {(() => {
                ...
                return guestEvents > 0 ? (
                  <p className="text-xs mb-3 inline-flex items-center gap-1.5 rounded-full bg-[#FFE4E8] text-[#670626] px-3 py-1">
        ...
        <Dialog open={!!resetResult} onOpenChange={(o) => { if (!o) setResetResult(null); }}>
          <DialogContent className="max-w-sm">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between gap-2 rounded-lg border border-border bg-[#FFF1F3]/60 px-3 py-2.5">
                <code className="text-lg font-bold tracking-wide text-[#2B0911]">{resetResult?.tempPassword}</code>
                <Button
