      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        {dynamicPolicy ? (
          ...
          <div className="prose-neutral space-y-6 text-[0.92rem] text-muted-foreground leading-[1.8]">
            ...
            <p>
              En <strong className="text-foreground">Pilates Room</strong> nos esforzamos por ofrecer la mejor experiencia a cada persona que entrena con nosotros. Estas políticas de cancelación nos permiten mantener un servicio de calidad y garantizar disponibilidad para ti y para el resto del grupo.
            </p>
            ...
            <p>
              Estas excepciones requieren notificación por escrito a <strong className="text-primary">pilatesroomoilslove@gmail.com</strong> con documentación de soporte y quedan a criterio de la administración del estudio.
            </p>
